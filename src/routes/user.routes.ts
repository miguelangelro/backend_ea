...
import {getAllUsers, getUser, updatePassword, deleteUser, updateUser, contactUs, deleteUsuario2} from '../controllers/user.controller'
...
router.delete('/:id',TokenValidation, deleteUsuario2);
